const API_URL = "https://early-confirmed-narcissus.glitch.me";
...
const renderCartItems = async () => {
  ...
  const products = JSON.parse(
    localStorage.getItem("cartProducrDetails") || "[]"
  );
...
cartButton.addEventListener("click", async () => {
  ...
  localStorage.setItem("cartProducrDetails", JSON.stringify(products));
  renderCartItems();
});
